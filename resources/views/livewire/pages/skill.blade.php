<div class=" h-44 mt-4 w-44 relative">
    @if ($skill->image)
        <img src="{{asset('storage/'.$skill->image)}}" class="w-full object-fill rounded-2xl relative top-0 left-0" alt="{{$skill->name}}">
    @endif
    <div class="absolute top-0 rounded-2xl left-0 w-full h-full bg-gradient-to-b from-transparent via-transparent to-gray-800/80 flex items-end">
